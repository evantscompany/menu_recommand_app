    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            if aaa_account:
                ...
                print(f"      created_at: {aaa_account[3]}")
                
                # user_profiles에서 관련 profile 찾기
                result = conn.execute(text("""
                    SELECT profile_id, user_id, dietary_label, spicy_threshold, 
                ...
                if aaa_profile:
                    ...
                    print(f"      saltiness_preference: {aaa_profile[4]}")
                    print(f"      lunch_budget_max: {aaa_profile[5]}")
                    print(f"      is_adventurous: {aaa_profile[6]}")
